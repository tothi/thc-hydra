STRIP=strip
XDEFINES= -DHAVE_MYSQL_MYSQL_H -DLIBOPENSSL -DLIBNCURSES -DLIBFIREBIRD -DLIBIDN -DHAVE_PR29_H -DHAVE_PCRE -DLIBMYSQLCLIENT -DLIBAFP -DLIBPOSTGRES -DLIBSVN -DLIBSSH -DHAVE_ZLIB -DHAVE_GCRYPT -DLIBMCACHED -DLIBMONGODB -DLIBBSON -DLIBFREERDP -DLIBWINPR2 -DLIBSMBCLIENT -DHAVE_MATH_H -DHAVE_SYS_PARAM_H
XLIBS= -lgcrypt -lz -lcurses -lssl -lfbclient -lidn -lpcre2-8 -lmysqlclient -lafpclient -lpq -lsvn_client-1 -lapr-1 -laprutil-1 -lsvn_subr-1 -lssh -lcrypto -lmemcached -lmongoc-1.0 -lbson-1.0 -lfreerdp2 -lwinpr2 -lsmbclient
XLIBPATHS=-L/usr/lib -L/usr/local/lib -L/lib -L/usr/lib32 -L/lib64 -L/usr/lib32 -L/lib64 -L/usr/lib32 -L/lib64 -L/usr/lib32 -L/lib64
XIPATHS= -I/usr/include/mysql -I/usr/include -I/usr/include -I/usr/include -I/usr/include -I/usr/include -I/usr/include -I/usr/include/subversion-1 -I/usr/include/apr-1 -I/usr/include/subversion-1 -I/usr/include/afpfs-ng -I/usr/include/libmemcached -I/usr/include/libmongoc-1.0 -I/usr/include/libbson-1.0 -I/usr/include/freerdp2 -I/usr/include/winpr2 -I/usr/include/samba-4.0
PREFIX=/usr/local
